...
\resumeSubHeadingListStart
    \resumeSubheading
        ...
        {\textbf{M.Sc.} in Applied Mathematics and Physics, Plasma Physics, \textbf{GPA}: 4.76/5.0}{Moscow, Russian Federation}
    ...
    \resumeSubheading
        ...
        {\textbf{B.Sc.} in Technical Physics, Aerospace Technology, \textbf{GPA}: 4.53/5.0}{Moscow, Russian Federation}
