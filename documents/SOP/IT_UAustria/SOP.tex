...
{\centering
  ...
  {\fontsize{10}{10}\selectfont Space Engineering} $|$
  {\fontsize{10}{10}\selectfont Interdisciplinary Transformation University Austria} \\
  {\fontsize{10}{10}\selectfont Communications \& Efficiency: Energy-Efficient Communication Systems for Next-Generation CubeSats}
\par}
\vspace{-15pt}
...
My research objective is to develop energy efficient communication systems for next generation CubeSats under strict power and bandwidth constraints. The project focuses on uplink and downlink design, low power communication protocols, and real time optimization to ensure reliable data transfer in space constrained environments. The Smart Sensing and Systems Lab at Interdisciplinary Transformation University Austria works on embedded systems, edge AI, and wireless sensor networks, which provides a foundation for adaptive communication and on board inference in CubeSat systems. This setting connects communication theory, embedded computing, and space system requirements into a unified research path.
...
Under the supervision of the Smart Sensing and Systems Lab team and in collaboration with partner groups, I will contribute to the development of energy efficient communication architectures for CubeSats. Work will include protocol design and cross layer optimization, together with real time embedded signal processing for adaptive data transmission. Experience with programmable hardware, verification workflows, and automated measurement control supports implementation of low power communication pipelines and reproducible performance evaluation. This approach supports integration of embedded machine learning, including attention based models and TinyML, when it improves communication efficiency.

This project advances my research path from device level physics toward energy efficient communication and on board intelligence for space systems. The combination of embedded systems, edge AI, and low power communication protocols enables adaptive links that conserve energy while sustaining data throughput for CubeSat missions. The work at Interdisciplinary Transformation University Austria will produce algorithmic and hardware software codesign methods that can transfer to small satellite platforms and other resource constrained embedded systems. This trajectory supports my long term goal of developing reliable communication and sensing systems for space and autonomous platforms.
