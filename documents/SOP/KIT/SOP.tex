...
I find it remarkable that solid-state devices can convert microscopic charge motion into precise measurements of particle interactions. My goal is to help design the detector electronics and real-time processing systems that enable those measurements in high-rate experiments. The multidisciplinary nature of research at KSETA is exactly what I am looking for in my career, and I want to use what I have learned in radiation effects on electronics, device characterization, and system verification to advance its research, from design and verification to experimental testing and long-term reliability assessment. My goal is to contribute to detector electronics and processing systems that remain stable in harsh environments while meeting real-time requirements.
