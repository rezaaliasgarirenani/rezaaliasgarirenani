...
I joined Dr.\ Koveshnikov's laboratory at the Institute of Microelectronics Technology, RAS, to study radiation effects in \ce{SiO2}-based MOS devices. I designed C-V and TSC experiments to separate oxide, interface, and semiconductor trap contributions after electron and gamma irradiation and hydrogen plasma treatment, and the results led to a first-author journal paper\footnote{R. Aliasgari Renani, O.A. Soltanovich, M.A. Knyazev, S.V. Koveshnikov, Investigation of low energy electron irradiated \ce{SiO2} based MOS devices by C-V and TSC techniques, \textit{Russian Microelectronics}, 2023, DOI: \href{https://doi.org/10.1134/S1063739723600516}{10.1134/S1063739723600516}.} and a conference presentation. I developed MATLAB automation\footnote{Reza Aliasgari Renani, \textit{Automation Programs for Electrical Characterization Techniques}, available online: \href{https://github.com/rezaaliasgarirenani/IMT-Automation}{https://github.com/rezaaliasgarirenani/IMT-Automation}} programs for TSC, C-V, I-V, I-T, and DLTS measurements, which reduced run-times and enabled repeatable workflows. My tasks at IMT required independent planning, management of concurrent tasks, and clear documentation of methods and results.

After my undergraduate degree, I joined the System-on-Chip Development Laboratory under the supervision of Dr.\ Vasiliev to develop FPGA-based systems. I implemented video-processing algorithms in Verilog using both manual coding and HDL generated from Simulink models, built verification testbenches, and used Python for quality control. For these pipelines, I wrote a fixed-point library and LUT-based function approximations to support efficient DSP. I then synthesized the design, checked resource utilization (LUTs and BRAM), and validated it on a Xilinx Zybo Z7 with live camera input and HDMI output. The codebase was maintained under Git-based version control.
