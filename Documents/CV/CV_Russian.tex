...
\usepackage{mathptmx} % Times New Roman-like font, but with T2A it should support Cyrillic
...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
        ...
        {\textbf{Магистр} прикладной математики и физики, Программа: Физика плазмы, GPA: 4.7/5.0}{Москва, Россия}
    ...
    \resumeSubheading
        ...
        {\textbf{Бакалавр} технической физики, Программа: Аэрокосмические технологии, GPA: 4.56/5.0}{Москва, Россия}
...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
        {\href{http://ai.mipt.ru/design-center}{\parbox[t]{\dimexpr\linewidth-7cm}{Дизайн-центр по проектированию микропроцессорной техники для систем с ИИ, Лаборатория разработки систем на кристалле}}}
    ...
    \resumeSubheading
        {\href{https://new.ras.ru/en/}{\parbox[t]{\dimexpr\linewidth-5cm}{Институт проблем технологии микроэлектроники и особочистых материалов Российской академии наук}}}{Март 2023 -- Август 2024}
...
\begin{center}
    ...
    \textbf{Русский}: B1 \quad $|$ \quad 
    \textbf{Немецкий}: B1 (ÖSD) \quad $|$ \quad 
