...
**M.S. in Applied Mathematics and Physics, Plasma Physics**  
...
### [Moscow Institute of Physics and Technology (MIPT, Phystech)](https://mipt.ru/)
**B.S. in Technical Physics, Aerospace Technology**  
Moscow, Russian Federation  
Sep 2020 - Jun 2024  
GPA: **4.53/5.0**
...
[1] <u>V. Vologin</u>, R. Aliasgari Renani, V. Vasilevskiy, and V. Chesnokov, "Comparative analysis of manual and Simulink-generated Verilog code for image processing algorithms," *[YADRO FPGA-Systems Conference](https://meetups.yadro.com/fpga-msk-1125/)*, 2025. Presentation

[2] <u>R. Aliasgari Renani</u>, O. A. Soltanovich, M. A. Knyazev, and S. V. Koveshnikov, "Study of SiO<sub>2</sub> based MOS by capacitance-voltage and thermally stimulated current techniques," *[The 15th International Conference on Micro- and Nanoelectronics](https://icmne.ftian.ru)*, 2023, p. 122. [Presentation](https://icmne.ftian.ru/wp-content/uploads/icmne-2023_e-version.pdf)

[3] <u>R. Aliasgari Renani</u>, O. A. Soltanovich, M. A. Knyazev, and S. V. Koveshnikov, "Investigation of electrically active defects introduced into silicon oxide by irradiation of low-energy electrons, by methods of capacitance-voltage characteristics and thermally stimulated current," *[Second Joint Conference on Electron Beam Technologies and X-ray Optics in Microelectronics](https://cebt23.iptm.ru)*, 2023. [Poster](https://cebt23.iptm.ru/download/numbered/91.pdf)
...
| Electrical Characterization | Vivado, Vitis |
| Data Processing, LaTeX | Git, Unix/Linux OS |
| MATLAB, Simulink, HDL Coder | OriginLab |
| Verilog, RTL Design | SolidWorks |
| FPGA Development | ERDAS IMAGINE |
| Fixed-Point Computations | PCB, EasyEDA |
| SciPy, Cocotb, OpenCV | OpenRocket |

## Projects

### [Model Rocket](https://github.com/icarus-imperium/rocket-2025)
**Apr 2023 and Apr 2025**
...
- Full Russian Government Scholarship for International Students, MIPT (Master's Program) (Sep 2024)
- Iranian Government Scholarship, Isfahan University of Technology (Bachelor's Program) (Sep 2019)
