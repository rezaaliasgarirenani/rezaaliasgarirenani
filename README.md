...
### [Laboratory of Software and System-on-Chip Development, Design Center for the Development of Microprocessor Technology for AI Systems, MIPT](http://ai.mipt.ru/design-center)
...
[1] <u>R. Aliasgari Renani</u> et al., "Investigation of FPGA resource utilization in manual and Simulink-generated Verilog implementations of image signal processing algorithms," in Proc. *28th International Conference on Digital Signal Processing and its Applications* (*DSPA*), 2026, Conference Paper, [DOI](https://doi.org/10.1109/DSPA69176.2026.11476776).

[2] <u>R. Aliasgari Renani</u> and M. N. Vasiliev, "Simulating space environments with electron-beam plasma for FPGA radiation testing," *68th All-Russian Scientific Conference of MIPT*, 2026, [Presentation](https://conf.mipt.ru/conference/23999).

[3] <u>V. Vologin</u>, R. Aliasgari Renani, V. Vasilevskiy, and V. Chesnokov, "Comparative analysis of manual and Simulink-generated Verilog code for image processing algorithms," *YADRO FPGA-Systems Conference*, 2025, [Presentation](https://meetups.yadro.com/fpga-msk-1125/).

[4] O. A. Soltanovich, <u>R. Aliasgari Renani</u>, S. V. Koveshnikov, M. A. Knyazev, A. V. Kovalchuk, and S. Yu. Shapoval, "Study of the traps in SiO<sub>2</sub> and Si<sub>3</sub>N<sub>4</sub> generated by low-energy electron irradiation and hydrogen plasma treatment using capacitance-voltage and thermally stimulated current techniques," in Proc. *15th International Conference on Micro- and Nanoelectronics* (*ICMNE*), 2023, p. 122, Presentation, [DOI](https://doi.org/10.29003/m3563.ICMNE-2023).
...
- [Model Rockets:](https://github.com/icarus-imperium/) Built and launched several rockets (30 N·s impulse) for yearly MIPT Cosmonautics Day events.
